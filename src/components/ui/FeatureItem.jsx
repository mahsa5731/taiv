...
export default function FeatureItem({ src, title, desc }) {
    ...
    return (
        <div className='relative flex w-full min-h-64 h-full '>
            ...
            <div className='flex flex-col justify-center items-center p-4 w-full h-full bg-black/60 absolute z-20'>
                <h3 className='font-bold bg-gradient-to-r from-[#EF8D82]  to-[#9974ff] bg-clip-text text-transparent text-lg md:text-6xl'>{title}</h3>
